...
import static com.cherkashin.telegramBot.constant.Supportive.Commands.CallbackQuery.REQUEST_PREVIOUS_LIST_VACANCIES;

@Component(REQUEST_PREVIOUS_LIST_VACANCIES)
@RequiredArgsConstructor
@FieldDefaults(level = AccessLevel.PRIVATE, makeFinal = true)
public class CallbackQueryRequestPreviousListVacancies implements CommandRule {
